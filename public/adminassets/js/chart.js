...
var categoryCounts = document.getElementById('categoryCounts').value;
var pcount1 = document.getElementById('pcount').value;
var categoryNamesArray = categoryNames.split(",");
console.log(categoryNamesArray)
 var catCount = categoryCounts.split(',');
 console.log(catCount);
 var pcount = pcount1.split(",");

console.log(pcount);
 var payment = document.getElementById("pType").value;
console.log(payment)
 var paymentArray = payment.split(",");
